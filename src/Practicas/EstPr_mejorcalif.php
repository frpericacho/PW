<!DOCTYPE html>
<html>
<head><title>Mejor Media</title></head>
	<body>
		...
		<?php
                ...
                if (isset($enviar)) {
                    ...
                    $consulta = 'select respuesta from respuestas where respuestas.id_cuestion=1 and respuestas.id_profesor='.$_POST['profesor'].'';
					...
					<form method="POST" action="EstPr_mejorcalif.php">
