			...
			error_Reporting(E_ALL & ~E_NOTICE);
				...
				if($n > 0){
					...
					if(isset($enviar)){
						...
						$con="select id_profesor from encuesta where encuesta.id_estudiante=".$c['id']."";
						$a=mysqli_query($conexion,$con);
						...
						for($i=1;$i<=$n;$i++){
							...
							if(isset($respuesta)){
								...
								$insertar="insert into respuestas(respuesta,id_cuestion,id_estudiante,id_profesor) values($respuesta,$i,".$c['id'].",".$d['id_profesor'].")";
